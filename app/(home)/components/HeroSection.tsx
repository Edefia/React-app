...
export default function HeroSection(){
    ...
    return (
        <div className="min-h-[60vh] flex flex-col-reverse gap-15 lg:gap-0 lg:flex-row items-center justify-between animate-move-up">
            <div className="space-y-10 text-center lg:text-left">
                <h1 className="text-4xl lg:text-7xl font-bold">
                    Nice to Meet You!
                    <br /> <span className="underline underline-offset-8 decoration-green-500">{"I am Hebra."}</span>
                </h1>
                <div className="md:w-96 text-lg text-gray-300 flex flex-wrap">
            ...
            <div className="relative sm:py-15 md:py-10 ">
                <div className="w-80 h-80 space-y-2 border-white-[2px]  relative">
                <div>
                    <Image
                    src={IMG_0295}
                    alt="Hebra Dalton"
                    className="rounded-full object-cover h-100 md:h-120 lg:h-150 w-100 md:w-120 lg:w-150 circ"
                    />
                </div>
                </div>
